...
function EditProductPage({ params }) {
    ...
    const [imageInput, setImageInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const categories = [
        'Accessories',
        'Electronics',
        'Clothing',
    ...
    const fetchProduct = async ()=>{
        try {
            ...
            if (response.ok) {
                ...
                setImages(productData.images || (productData.imageUrl ? [
                    productData.imageUrl.replace('assets/Product_Image/', '/products/')
                ] : []));
            } else {
...
_s(EditProductPage, "Y5DQP2jxWYhBgmNln2YouHGsEww=", false, function() {
    return [
...
//# sourceMappingURL=_a0037663._.js.map