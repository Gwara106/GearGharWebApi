...
function DashboardPage() {
    ...
    const { user, logout, isLoading, updateUser, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            if (isAuthenticated() && !isLoading) {
                const fetchUserData = {
                    "DashboardPage.useEffect.fetchUserData": async ()=>{
                        try {
                            const getCookie = {
                                "DashboardPage.useEffect.fetchUserData.getCookie": (name)=>{
                                    const value = `; ${document.cookie}`;
                                    const parts = value.split(`; ${name}=`);
                                    if (parts.length === 2) return parts.pop()?.split(';').shift();
                                    return null;
                                }
                            }["DashboardPage.useEffect.fetchUserData.getCookie"];
                ...
                }["DashboardPage.useEffect.fetchUserData"];
                fetchUserData();
            }
        }
    }["DashboardPage.useEffect"], [
...
_s(DashboardPage, "UqEsq32lB42uFgaaiYKatSeyryw=", false, function() {
    return [
...
//# sourceMappingURL=_3fadfbad._.js.map