...
async function GET(request) {
    try {
        ...
        console.log('API: Product model check:', !!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Product"]);
        ...
        console.log('API: Fetching orders with query:', {
            page,
            limit,
            status,
            query
        });
        const orders = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Order"].getAllOrders(page, limit, status);
        const total = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Order"].countDocuments(query);
        console.log('API: Found orders count:', orders.length);
        console.log('API: Sample orders:', orders.slice(0, 3).map((o)=>({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c682f032._.js.map