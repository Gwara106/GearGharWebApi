...
async function GET(request, { params }) {
    try {
        const { id } = params;
        const product = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mockProducts"].find((p)=>p._id === id && p.status === 'active');
        if (!product) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__26dfbed0._.js.map